...
pub struct StateDump {
    ...
    pub show_help: bool,
    pub leader: bool,
    pub active_leader_mode: Option<crate::app::LeaderMode>,
    pub theme_picker_mode: bool,
    pub theme_picker_index: usize,
    pub theme_name: String,
    pub cursor_style: crate::app::CursorStyle,
    pub boxed_chrome: bool,
    pub theme_swatch_style: crate::app::ThemeSwatchStyle,
...
pub fn state(app: &App) -> StateDump {
    StateDump {
        ...
        leader: app.leader,
        active_leader_mode: app.active_leader_mode.clone(),
        theme_picker_mode: app.theme_picker_mode,
        theme_picker_index: app.theme_picker_index,
        theme_name: app.theme_name.clone(),
        cursor_style: app.cursor_style.clone(),
        boxed_chrome: app.boxed_chrome,
        theme_swatch_style: app.theme_swatch_style.clone(),
        theme_swatch_spacing: app.theme_swatch_spacing,
